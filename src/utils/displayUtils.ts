...
/**
 * Displays the details of a `DetailedRecord` object.
 * 
 * This function demonstrates important programming concepts:
 * - **Variables**: The function accesses properties (variables) from the `DetailedRecord` object to print each detail.
 * - **Methods**: The `displayRecord` function encapsulates the logic to display a `DetailedRecord` object.
 ...
 * 
 * The function outputs each key property of the `DetailedRecord`, such as the company name, pipeline, location, and throughput details, with color-coding for better readability in the terminal.
 * 
 * **Key Concepts**:
 ...
 *
 * 
 * @param record - The `DetailedRecord` object containing data to be displayed. It holds details like date, company, pipeline, etc.
 * @returns void - This function does not return any value; it only prints to the console.
 * 
 * @example
 * ```ts
 * const record = new DetailedRecord('2024-01-01', 1, 2024, 'Company A', 'Pipeline X', 'Location Y', 48.123, -97.456, 'south', 'export', 'oil', 100, 50, 50, 120, 100, 'No variance');
 * displayRecord(record);
 * ```
 * This example shows how to create a `DetailedRecord` object and use `displayRecord` to print its details.
 * 
 * @author Harmeet Matharoo
 */
export function displayRecord(record: BaseRecord): void {
