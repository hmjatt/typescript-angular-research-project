 ...
 */
    it('should display the record details with correct formatting', () => {
        ...
        expect(console.log).toHaveBeenCalledWith(pc.blue('Committed Volumes (1000 m3/d):'), pc.green('50'));
        expect(console.log).toHaveBeenCalledWith(pc.blue('Uncommitted Volumes (1000 m3/d):'), pc.green('50'));
        expect(console.log).toHaveBeenCalledWith(pc.blue('Nameplate Capacity (1000 m3/d):'), pc.green('120'));
        expect(console.log).toHaveBeenCalledWith(pc.blue('Available Capacity (1000 m3/d):'), pc.green('100'));
        expect(console.log).toHaveBeenCalledWith(pc.blue('Reason For Variance:'), pc.green('No variance'));
    });
 ...
 */
    it('should display "N/A" for missing or null values, and keep 0 as a valid value', () => {
        ...
        expect(console.log).toHaveBeenCalledWith(pc.blue('Latitude:'), pc.green('0')); // 0 is a valid value
        expect(console.log).toHaveBeenCalledWith(pc.blue('Longitude:'), pc.green('0')); // 0 is a valid value
        ...
        expect(console.log).toHaveBeenCalledWith(pc.blue('Throughput (1000 m3/d):'), pc.green('0')); // 0 is a valid value
        expect(console.log).toHaveBeenCalledWith(pc.blue('Committed Volumes (1000 m3/d):'), pc.green('0')); // 0 is a valid value
        expect(console.log).toHaveBeenCalledWith(pc.blue('Uncommitted Volumes (1000 m3/d):'), pc.green('0')); // 0 is a valid value
        expect(console.log).toHaveBeenCalledWith(pc.blue('Nameplate Capacity (1000 m3/d):'), pc.green('0')); // 0 is a valid value
        expect(console.log).toHaveBeenCalledWith(pc.blue('Available Capacity (1000 m3/d):'), pc.green('0')); // 0 is a valid value
